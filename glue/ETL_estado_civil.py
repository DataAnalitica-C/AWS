...
def main():
    try:
        ...
        s3_output_path = "s3://rawdatacontactar/fst009_estado_civil"
        
        sql_query = """
        SELECT 
            Eccod AS CodEstadoCivBT,
            Ecnom AS DesEstadoCivil,
            GETDATE() AS Fecha_carga_Bodega,
            GETDATE() AS Fecha_corte_info,
            1 AS estado
        FROM FST009
        """
        ...
        write_to_s3_parquet(source_data, s3_output_path, "write_fst009_estado_civil")

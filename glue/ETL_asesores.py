...
def main():
    try:
        ...
        s3_output_path = "s3://rawdatacontactar/SNGAS2_asesores"
        ...
        SELECT  
            ...
            E.Valor AS EMAIL 
        FROM SNGAS2 C
        INNER JOIN FSE046 E ON C.SNGAS2Usr = E.Ubuser
        LEFT JOIN FST746 T746 ON C.SNGAS2USR = T746.UBUSER
        LEFT JOIN FST046 F046 ON C.SNGAS2USR = F046.UBUSER 
        ...
        write_to_s3_parquet(source_data, s3_output_path, "write_SNGAS2_asesores")
